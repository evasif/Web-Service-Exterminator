...
namespace Exterminator.Repositories.Implementations
{
    public class LogRepository : ILogRepository
    {
        ...
        // TODO: Should contain a method which retrieves all logs 
        //(LogDto) ordered by timestamp (descending)
        public IEnumerable<LogDto> GetAllLogs() => _dbContext.Logs.OrderByDescending(l => l.Timestamp).Select(l => new LogDto
        {
            Id = l.Id,
